...
const Footer: React.FC = () => {
  return (
    <footer className="w-full py-4 sm:py-6 responsive-padding bg-gradient-to-r from-gray-900/80 to-gray-800/80 backdrop-blur-sm border-t border-white/10">
        ...
        <div className="flex flex-col gap-4 sm:gap-6">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="text-center lg:text-right">
              <p className="text-gray-300 text-xs sm:text-sm mb-2">Contact</p>
